...
describe('A Figure Calculator', () => {
  it('should calculateRectanglePerimeter, calculateRectangleArea, calculateTrianglePerimeter, and calculateTriangleArea functions', () => {
  ...
  describe('A calculateTrianglePerimeter function', () => {
    ...
    it('should throw error when given with non-number parameters', () => {
      ...
      expect(() =>
        figureCalculator.calculateTrianglePerimeter(true, {}, '1')
      ).toThrowError();
      expect(() =>
    ...
    it('should return correct value based on rectangle area formula', () => {
      ...
      // Assert
      expect(result).toEqual(50); // 2 x (length + width)
      expect(spyAdd).toHaveBeenCalledWith(sideA, sideB); // (length + width)
  ...
  describe('A calculateTriangleArea function', () => {
    ...
    it('should return correct value based on rectangle area formula', () => {
      ...
      // Assert
      expect(result).toEqual(75); // 2 x (length + width)
      expect(spyMultiply).toHaveBeenCalledWith(base, height);
      expect(spyDivide).toHaveBeenCalledWith(base * height, 2); // (length + width)
    });
  });
});
